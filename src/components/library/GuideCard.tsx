...
export function GuideCard({
  ...
  return (
    <button
      ...
      className="soft-surface group relative block w-full overflow-hidden rounded-3xl border border-gold/45 bg-card text-left shadow-[var(--shadow-soft)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-background"
    >
